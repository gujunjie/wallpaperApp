...
import tuijian.presenter.Presenter;

public class TuiJianFragment extends BaseFragment<IView,Presenter> implements IView{
    ...
    public void showNewsData(NewsBean.DataBean dataBean) {
        ...
        List<NewsBean.DataBean.EntBean> entBeanList=dataBean.getEnt();
        List<NewList> newList=new ArrayList<>();

        newList.addAll(entBeanList);
