...
import keji.presenter.Presenter;
import tuijian.model.NewList;
import tuijian.model.NewsBean;

public class KeJiFragment extends BaseFragment<IView,Presenter> implements IView {
    ...
    public void showNewsData(NewsBean.DataBean dataBean) {
        List<NewsBean.DataBean.TechBean> techBeanList=dataBean.getTech();
        List<NewList> newList=new ArrayList<>();

        newList.addAll(techBeanList);
