...
import newscar.presenter.Presenter;
import tuijian.model.NewList;
import tuijian.model.NewsBean;

public class NewsCarFragment extends BaseFragment<IView,Presenter> implements IView {
    ...
    public void showNewsData(NewsBean.DataBean dataBean) {
        List<NewsBean.DataBean.AutoBean> autoBeanList=dataBean.getAuto();
        List<NewList> newList=new ArrayList<>();

        newList.addAll(autoBeanList);
