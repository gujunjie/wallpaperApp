...
import caijing.presenter.Presenter;
import tuijian.model.NewList;
import tuijian.model.NewsBean;

public class CaiJingFragment extends BaseFragment<IView,Presenter> implements IView{
    ...
    public void showNewsData(NewsBean.DataBean dataBean) {
        List<NewsBean.DataBean.MoneyBean> moneyBeanList=dataBean.getMoney();
        List<NewList> newList=new ArrayList<>();

        newList.addAll(moneyBeanList);
