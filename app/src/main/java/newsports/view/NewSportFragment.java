...
import newsports.presenter.Presenter;
import tuijian.model.NewList;
import tuijian.model.NewsBean;

public class NewSportFragment extends BaseFragment<IView,Presenter> implements IView {
    ...
    public void showNewsData(NewsBean.DataBean dataBean) {
        List<NewsBean.DataBean.SportsBean> sportsBeanList=dataBean.getSports();
        List<NewList> newList=new ArrayList<>();

        newList.addAll(sportsBeanList);
