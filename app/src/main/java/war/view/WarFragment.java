...
public class WarFragment extends BaseFragment<IView,Presenter> implements IView {
    ...
    public void showNewsData(NewsBean.DataBean dataBean) {
        List<NewsBean.DataBean.WarBean> warBeanList=dataBean.getWar();
        List<NewList> newList=new ArrayList<>();

        newList.addAll(warBeanList);
